...
class Auth with ChangeNotifier {
  ...
  Future<void> tempData() async {
    ...
    // * MEMBUAT JEMBATAN ANTAR APLIKASI DENGAN LOCAL STORAGE
  ...
  Future<void> signup(String email, String password) async {
    Uri url = Uri.parse(
        "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDIX-o7bbg66G35mdWJa8ozWVYjUpTX7XQ");
  ...
  Future<void> login(String email, String password) async {
    Uri url = Uri.parse(
        "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDIX-o7bbg66G35mdWJa8ozWVYjUpTX7XQ");
  ...
  void _autoLogout() {
    ...
    // * DIFFERENCE = _EXPIRYDATE AKAN DIBANDINGKAN DENGAN WAKTU SEKARANG
    final timeToExpired = _tempexpiryDate.difference(DateTime.now()).inSeconds;
    print(timeToExpired);
